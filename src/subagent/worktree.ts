...
function withWorktreeLock<T>(repoRoot: string, fn: () => Promise<T>): Promise<T> {
...
export async function createWorktree(repoRoot: string, name: string): Promise<Worktree> {
  return withWorktreeLock(repoRoot, () => createWorktreeUnsafe(repoRoot, name));
}

async function createWorktreeUnsafe(repoRoot: string, name: string): Promise<Worktree> {
