"""KRIS-Bench official GPT-4o rubric prompts.

Adapted from mercurystraw/Kris_Bench (Apache-2.0). The wording is retained
for score comparability; path and API orchestration live in evaluate_kris_bench.py.
"""
